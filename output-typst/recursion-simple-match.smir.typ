...
#box(width: 190pt, height: 254pt, {
  ...
  place(dx: 136pt, dy: 54pt, polygon(
...
#table(
  ...
  align: (left, left),
  [*MIR*], [*Annotation*],
  [`→ switch(\_1) \[0→bb2; else→bb1\]`], [Branch on \_1],
)
...
=== bb6 #text(fill: rgb("#888888"), weight: "regular")[ — return / success]
